<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?= base_url('products/create') ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-4 py-2 rounded-xl transition shadow-md">
            ...
            <?php foreach($products as $product): ?>
                <tr class="border-b hover:bg-slate-50 transition">
                    ...
                    <td class="py-3 text-center flex items-center justify-center space-x-2">
                        <a href="<?= base_url('products/edit/'.$product['id']) ?>" class="text-blue-500 hover:text-blue-700 bg-blue-50 p-2 rounded-lg transition">
                        ...
                        <form action="<?= base_url('products/'.$product['id']) ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this product?');">
                            ...
                            <button type="submit" class="text-rose-500 hover:text-rose-700 bg-rose-50 p-2 rounded-lg transition">
